  ...
  const generatePdfLabels = async () => {
    ...
    for (let i = 0; i < total; i++) {
      ...
      if (esAlumno) {
        ...
        // --- Lógica optimizada para Profesores (2 líneas con jerarquía visual) ---
        ...
        if (formato === "54") {
          // --- Formato de 54 etiquetas (16mm de alto) ---

          // 1. Línea del Nombre (Más grande y en Negrita)
          doc.setFontSize(13.5);
          doc.setFont("helvetica", "bold");
          // Lo subimos un pelín por encima del centro vertical
          doc.text(nombre, centerX, centroY - 0.5, { align: "center" });

          // 2. Línea de los Apellidos (Más pequeña y Normal)
          doc.setFontSize(8.5);
          doc.setFont("helvetica", "normal");
          // Lo bajamos un pelín por debajo del centro vertical
          doc.text(apellidos, centerX, centroY + 3.5, { align: "center" });
        } else {
          // --- Formatos estándar más grandes (40, 24, 33) ---
          ...
          // 2. Línea de los Apellidos
          doc.setFontSize(10.5);
          doc.setFont("helvetica", "normal");
          doc.text(apellidos, centerX, centroY + 4.5, { align: "center" });
        }

        // Restauramos la fuente a normal para las siguientes iteraciones
        doc.setFont("helvetica", "normal");
      }
            ...
            <div>
              ...
              <Select value={formato} onValueChange={setFormato}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="54">54 (57.5 x 16 mm - 18x3)</SelectItem>
                </SelectContent>
              </Select>
            </div>
