...
export function PanelReservasDirectiva({ user, fecha, tabActivo }) {
  const [tab, setTab] = useState(tabActivo || "permisos"); // por defecto permisos
  ...
  return (
    <Card className="shadow-lg rounded-2xl h-[480px] flex flex-col">
      <CardContent className="flex-1 flex flex-col p-2 overflow-hidden">
        <Tabs
          value={tab}
          onValueChange={setTab} // así se controla desde fuera
